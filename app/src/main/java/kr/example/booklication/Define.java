...
public class Define {
    ...
    // 사용자가 쓴 독후감들을 저장할 리스트
    // (책 제목, 지은이, 날짜, 책을 읽게 된 동기, 줄거리, 느낀점)
    public ArrayList<ArrayList<String>> lstBookReport = new ArrayList<ArrayList<String>>();
    // 독후감의 내용을 저장할 리스트
    // (책 제목, 지은이, 날짜, 책을 읽게 된 동기, 줄거리, 느낀점)
    public ArrayList<String> lstBookReportInfo = new ArrayList<String>();
    // floating button은 false
    // listviewitem은 true
    public boolean bIscheck = false;
