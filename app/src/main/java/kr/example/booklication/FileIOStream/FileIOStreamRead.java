...
public class FileIOStreamRead {
    ...
    public String reportReadData(String fileName) {
        String sDataFilePath = aFileIOStreamRead.getFilesDir().getAbsolutePath()+"/bookreport/"+ fileName;

        System.out.println("report read fileName : " + fileName);
        System.out.println("report read setPath : " + sDataFilePath);
